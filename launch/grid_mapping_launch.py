...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument('minimum_occupancy', default_value='10'),
        DeclareLaunchArgument('partial_map_updates', default_value='True'),
        DeclareLaunchArgument('subscriber_qos_reliable', default_value='True'),
        DeclareLaunchArgument('subscriber_qos_transient_local', default_value='False'),
        DeclareLaunchArgument('publisher_qos_reliable', default_value='True'),
        DeclareLaunchArgument('publisher_qos_transient_local', default_value='False'),
    ]
    ...
    map_conversion_node = Node(
        ...
        parameters=[{
            ...
            'minimum_z': LaunchConfiguration('minimum_z'),
            'max_slope_ugv': LaunchConfiguration('max_slope_ugv'),
            'slope_estimation_size': LaunchConfiguration('slope_estimation_size'),
            'minimum_occupancy': LaunchConfiguration('minimum_occupancy'),
            'partial_map_updates': LaunchConfiguration('partial_map_updates'),
            'subscriber_qos_reliable': LaunchConfiguration('subscriber_qos_reliable'),
            'subscriber_qos_transient_local': LaunchConfiguration('subscriber_qos_transient_local'),
            'publisher_qos_reliable': LaunchConfiguration('publisher_qos_reliable'),
            'publisher_qos_transient_local': LaunchConfiguration('publisher_qos_transient_local'),
        }],
        remappings=[('octomap', 'octomap_binary')]
    )
